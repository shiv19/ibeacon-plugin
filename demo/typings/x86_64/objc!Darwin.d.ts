...
declare var _unpcb_list_entry: interop.StructType<_unpcb_list_entry>;
...
declare var dk_error_description_t: interop.StructType<dk_error_description_t>;
...
declare var gmonhdr_t: interop.StructType<gmonhdr_t>;
...
interface gmonparam {
	...
	fromssize: number;
	tos: interop.Pointer | interop.Reference<tostruct_t>;
	tossize: number;
	tolimit: number;
	lowpc: number;
	highpc: number;
...
interface rawarc_order_t {
	raw_frompc: number;
	raw_selfpc: number;
	raw_count: number;
	raw_order: number;
}
declare var rawarc_order_t: interop.StructType<rawarc_order_t>;
...
declare var rawarc_t: interop.StructType<rawarc_t>;
...
interface tostruct_t {
	selfpc: number;
	count: number;
	link: number;
	order: number;
}
declare var tostruct_t: interop.StructType<tostruct_t>;
