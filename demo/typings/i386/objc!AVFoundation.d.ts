...
declare class AVContentKeySession extends NSObject {
	...
	static pendingExpiredSessionReportsWithAppIdentifierStorageDirectoryAtURL(appIdentifier: NSData, storageURL: NSURL): NSArray<NSDictionary<any, any>>;

	static removePendingExpiredSessionReportsWithAppIdentifierStorageDirectoryAtURL(expiredSessionReports: NSArray<NSDictionary<any, any>>, appIdentifier: NSData, storageURL: NSURL): void;
